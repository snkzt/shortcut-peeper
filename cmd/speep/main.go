...
func run() error {
	...
	addKey := addCmd.String("key", "", `Key of the shortcut key e.g. "speep add --name copy --key Ctrl+C"`)
	addKeyShort := addCmd.String("k", "", `Key of the shortcut key e.g. "speep add -n copy -k Ctrl+C"`)
